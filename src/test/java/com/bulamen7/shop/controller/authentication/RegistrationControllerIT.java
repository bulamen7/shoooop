...
class RegistrationControllerIT {
    ...
    void shouldPatchProduct() throws Exception {
        mockMvc.perform(post("/register/add")
                ...
                .param("login", "log")
                .param("password", "pass123456789")
                .param("repeatedPassword", "pass123456789"));

        verify(userService).saveUser(new RegistrationForm("Arek", "log", "pass123456789", "randomMail@wp.pl", "pass123456789"));
    }
}